  ...
  return (
    <div>
      <div className="h-48">
        <ResponsiveContainer width="100%" height="100%">
          <ComposedChart data={rows} margin={{ top: 8, right: 8, left: -16, bottom: 0 }}>
            ...
            <Bar yAxisId="n" dataKey="visitors" name="방문자" fill="#d4d4d4" radius={[2, 2, 0, 0]} />
      ...
      <div className="mt-2 flex flex-wrap gap-4 text-xs text-muted-foreground">
        <span><i className="mr-1 inline-block h-2.5 w-2.5 rounded-sm bg-[#d4d4d4] align-[-1px]" />방문자</span>
